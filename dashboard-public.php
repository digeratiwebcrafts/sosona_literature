            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline d-flex">
                    ...
                    <div class="page-title d-flex w-100 align-items-center">
                        ...
                        <a href="accounts-public.php" class="btn btn-primary ml-auto">Accounts</a>
                    </div>
                </div>
            </div>
            <!-- /page header -->
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row alternate-row">
                                    ...
                                    <div class="col-6">
                                        <p class="mb-0"><a href="accounts-public.php?&consigneeId=<?=$row['consignee_id']?>"><?php  echo $row['name'] ?></a></p>
                                    </div>
                                    <div class="col-5">
